# METI 네이티브앱 개발 에이전트 프롬프트 v2.4

> **최종 업데이트**: 2026-05-05  
> **이전 버전**: v2.3 (2026-05-05)  
> **변경 사항 요약**:  
> - 다중 그룹 관리 UX 확정 (한 사용자가 여러 그룹 동시 관리 가능)  
> - 앱 그룹 관리 탭: 관리 중인 그룹 목록 → 그룹별 진입 구조 명세  
> - 헤더 드롭다운 전환 UX 구체화  
> - 화면별 API 호출 맵 — 내 그룹 목록 항목 추가  
...
*METI NativeApp Agent Prompt v2.4 — 2026-05-05*
